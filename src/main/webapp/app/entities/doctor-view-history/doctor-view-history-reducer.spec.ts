...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './doctor-view-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCTORVIEWHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_DOCTORVIEWHISTORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCTORVIEWHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCTORVIEWHISTORY actions', async () => {
      const arg = { id: 27572 };
    ...
    it('dispatches UPDATE_DOCTORVIEWHISTORY actions', async () => {
      const arg = { id: 27572 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCTORVIEWHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCTORVIEWHISTORY actions', async () => {
      const arg = 42666;
