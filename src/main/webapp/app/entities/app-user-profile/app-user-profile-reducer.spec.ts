...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPUSERPROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_APPUSERPROFILES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPUSERPROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPUSERPROFILE actions', async () => {
      const arg = { id: '5b426bb0-c972-43aa-b41e-cae5cd5b4e4f' };
    ...
    it('dispatches UPDATE_APPUSERPROFILE actions', async () => {
      const arg = { id: '5b426bb0-c972-43aa-b41e-cae5cd5b4e4f' };
    ...
    it('dispatches PARTIAL_UPDATE_APPUSERPROFILE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_APPUSERPROFILE actions', async () => {
      const arg = 42666;
