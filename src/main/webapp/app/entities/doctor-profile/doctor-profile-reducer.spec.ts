...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCTORPROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_DOCTORPROFILES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCTORPROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCTORPROFILE actions', async () => {
      const arg = { id: 'cbf8a861-78dc-4c44-bade-9e415bc23444' };
    ...
    it('dispatches UPDATE_DOCTORPROFILE actions', async () => {
      const arg = { id: 'cbf8a861-78dc-4c44-bade-9e415bc23444' };
    ...
    it('dispatches PARTIAL_UPDATE_DOCTORPROFILE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_DOCTORPROFILE actions', async () => {
      const arg = 42666;
