...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYMPTOMSEARCH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SYMPTOMSEARCHES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SYMPTOMSEARCH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SYMPTOMSEARCH actions', async () => {
      const arg = { id: 5494 };
    ...
    it('dispatches UPDATE_SYMPTOMSEARCH actions', async () => {
      const arg = { id: 5494 };
    ...
    it('dispatches PARTIAL_UPDATE_SYMPTOMSEARCH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SYMPTOMSEARCH actions', async () => {
      const arg = 42666;
