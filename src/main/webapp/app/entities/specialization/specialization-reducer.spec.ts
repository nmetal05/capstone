...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALIZATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SPECIALIZATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPECIALIZATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPECIALIZATION actions', async () => {
      const arg = { id: 30083 };
    ...
    it('dispatches UPDATE_SPECIALIZATION actions', async () => {
      const arg = { id: 30083 };
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALIZATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPECIALIZATION actions', async () => {
      const arg = 42666;
