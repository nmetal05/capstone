...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCTORDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_DOCTORDOCUMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCTORDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCTORDOCUMENT actions', async () => {
      const arg = { id: 30272 };
    ...
    it('dispatches UPDATE_DOCTORDOCUMENT actions', async () => {
      const arg = { id: 30272 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCTORDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCTORDOCUMENT actions', async () => {
      const arg = 42666;
