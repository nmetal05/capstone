...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GUESTSESSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_GUESTSESSIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GUESTSESSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GUESTSESSION actions', async () => {
      const arg = { id: 28897 };
    ...
    it('dispatches UPDATE_GUESTSESSION actions', async () => {
      const arg = { id: 28897 };
    ...
    it('dispatches PARTIAL_UPDATE_GUESTSESSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GUESTSESSION actions', async () => {
      const arg = 42666;
