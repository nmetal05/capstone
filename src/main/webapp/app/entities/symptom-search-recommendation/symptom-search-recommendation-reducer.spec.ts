...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './symptom-search-recommendation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYMPTOMSEARCHRECOMMENDATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SYMPTOMSEARCHRECOMMENDATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SYMPTOMSEARCHRECOMMENDATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SYMPTOMSEARCHRECOMMENDATION actions', async () => {
      const arg = { id: 3555 };
    ...
    it('dispatches UPDATE_SYMPTOMSEARCHRECOMMENDATION actions', async () => {
      const arg = { id: 3555 };
    ...
    it('dispatches PARTIAL_UPDATE_SYMPTOMSEARCHRECOMMENDATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SYMPTOMSEARCHRECOMMENDATION actions', async () => {
      const arg = 42666;
